...
data = dataWithSubject[,!(names(dataWithSubject)%in% c("subject.","total_UPDRS"))]
...
coef(cvElastic)
predict(cvElastic, type = "coefficients")
predict(cvElastic,testMat,s = "lambda.min")
plot(cvElastic, type = "coefficients")
autoplot(cvElastic)
